...
Jangann lupa ya kasih tq to nama gua "Arasyaa", yang mau recode izin ke gua dulu aja https://wa.me/17155448800
...
grupct = "https://wa.me/17155448800";
owner = "6288227606701";
nama_owner = "ikky@2";
instagram = "Rifqi.kn2";
yt = "-";
...
module.exports = syaa = async (syaa, mek) => {
  try {
    ...
    //MESS
    mess = {
      wait: `Tunggu Sebentar ya kak, sedang ikky Proses nihh!!`,
...
`;
        sendButImage(from, menu, "by @ikky ❤️", thumb, [
          {
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @ikky`, [
          {
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By @ikky`, [
          {
...
case "report":
                    ...
                    syaa.sendMessage('17155448800@s.whatsapp.net', options, text, {quoted: mek})
...
break
                    ...
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @ikky', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
reply(`wait loading`)
                ...
                reply(teks)
                break
case 'donhebehshhshsjsat':
              reply(`◪ *DOneneejnenssNASI*
  │
  ├─ ❏ *GOPAY*
  ├─ ❏ 088213292687
  ├─ ❏ *OVO*
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 171554488008|Arasya
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `ikky Bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai ikky Bot. :
...
break
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @ikky`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@ikky`;
...
case 'play':
   if (!q) return reply('Linknya?')
              ...
              buttonsMessage = {footerText:'its me ikky', imageMessage: imageMsg,
...
*[Wait] Tunggu Sebentar..*`
      ...
      case 'braihsjsjsjsjjdnddnndndnnly':
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
if (budy.startsWith('@17155448800')){
