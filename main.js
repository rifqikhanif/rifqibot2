...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["ikky Ganteng", "safari", "3.0"];
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(client.base64EncodedAuthInfo(), null, "\t")
        ...
        ownerNumber = ["6288227606701@s.whatsapp.net",`6288227606701@s.whatsapp.net`]
        dtod = "6288227606701@s.whatsapp.net"
       otod = `6288227606701@s.whatsapp.net`
...
fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;pemuda;;;\nFN:pemuda\nitem1.TEL;waid=6288227606701:6288227606701\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
